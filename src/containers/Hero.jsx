...
const Hero = () => {
  return (
    <section id="hero" className="px-8 bg-forest-green overflow-x-hidden">
      ...
      <div className="flex flex-col  whitespace-nowrap text-[11.5dvw] sm:text-[12.5dvw] xl:text-[13dvw] font-termina  text-bread-cream font-black leading-[0.8] w-screen">
        {/* <ReactFitty> */}
      ...
      <div className="w-full">
        ...
        <div className="big rounded-b-[24rem] w-full -mt-16 md:-mt-28 lg:-mt-32 md:w-medium lg:w-large xl:-mt-38 xl:w-xLarge 2xl:-mt-44 2xl:w-xxLarge mx-auto overflow-hidden relative">
          <div className="circle z-0 shadow-inner w-full aspect-square md:mt-28 lg:mt-32 xl:mt-38 2xl:mt-44 md:w-medium md:h-medium lg:w-large lg:h-large xl:w-xLarge xl:h-xLarge 2xl:w-xxLarge 2xl:h-xxLarge mt-16 rounded-full ">
